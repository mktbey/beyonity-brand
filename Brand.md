...
### Was KI tun darf
- Texte im Beyonity-Stil erstellen und variieren
...
## 10. Verwendung & Wartung

### Wie diese Datei nutzen

1. **Als LLM-Kontext:** Den relevanten Abschnitt direkt in den Prompt kopieren (oder die ganze Datei als Attachment)
2. **In Coding-Projekten:** Im Projekt-Root als `Brand.md` ablegen und in `CLAUDE.md` / `.cursorrules` referenzieren
3. **Im Team:** Neuen Mitarbeitenden als erstes Dokument schicken
4. **In CI/CD:** Als Validierungs-Referenz für automatisch generierten Content
